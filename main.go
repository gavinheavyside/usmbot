...
func lyric() {
	...
	lyrics := []string{
		...
		"A children's assortment, we're bigger than Hanley's, We've got Cabbage Patch orphans from Sylvanian Families",
		...
		"It leaves you a wreckage, Of postage and package, Sealed with Glasgow kiss",
